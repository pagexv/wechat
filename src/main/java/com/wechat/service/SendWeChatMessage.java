...
// 发送消息类型
    ...
    // 获取配置文件中的值
    private final static String CORPID = "wwc80765bb75f749b9";// 需要自己申请，官网有试用企业号
    // 可以申请试用
    private final static String CORPSECRET = "hHKPFJIVbOWSMYfRU59nbbWvxZlx8yJC8WLP3NoPDxU";
    // 获取访问权限码URL
